...
import io.github.pingpongboss.explodedlayers.samples.common.utils.Configuration
 ...
 * @param tabs The list of [TabNavItem]s to be displayed in the navigation.
 * @param startDestinationLabel The label of the tab that should be selected initially.
